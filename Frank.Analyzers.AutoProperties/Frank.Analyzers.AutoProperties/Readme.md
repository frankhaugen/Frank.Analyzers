...
### Frank.Analyzers.AutoProperties.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Frank.Analyzers.AutoProperties.Sample.csproj](../Frank.Analyzers.AutoProperties.Sample/Frank.Analyzers.AutoProperties.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Frank.Analyzers.AutoProperties.Tests
