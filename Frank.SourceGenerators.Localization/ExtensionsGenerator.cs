...
public class ExtensionsGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        var extensionClass = SyntaxFactory.ClassDeclaration("CultureExtensions")
            ...
            {
                GenerateMethod("GetCultureInfoName", "CultureInfoNameAttribute", "CultureInfoName", "code", "Culture"),
                GenerateMethod("GetNativeName", "NativeNameAttribute", "LocalName", "code", "Culture"),
                GenerateMethod("GetEnglishName", "EnglishNameAttribute", "EnglishName", "code", "Culture")
            }));
    ...
    public static MethodDeclarationSyntax GenerateMethod(string methodName, string attributeName, string propertyName, string parameterName, string parameterType)
    {
